...
void function::push(string label, bool debug)
{
	...
	throw exceptions::name_err("There is no variable " + label );
}
...
void function::add(bool debug)
{
	...
	if (debug) 
		cout << "ADD\t" << first_value << " + " << second_value << " = " << first_value + second_value << endl; 
...
void function::sub(bool debug)
{
	...
	if (debug) 
		cout << "SUB" << first_value << " - " << second_value << " = " << first_value - second_value << endl; 
...
void function::div(bool debug)
{
	...
	if (debug) 
		cout << "DIV" << first_value << " / " << second_value << " = " << first_value / second_value << endl; 
...
void function::mul(bool debug)
{
	...
	if (debug) 
		cout << "MUL" << first_value << " * " << second_value << " = " << first_value * second_value << endl; 
...
bool function::ifeq_flag(bool debug)
{
	...
	if (debug)
	{ 
		cout << first_value << " is equale " << second_value << ": ";
