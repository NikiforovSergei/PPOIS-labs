...
private:
	...
	/// \brief Выделение памяти для динамического двумерного массива.
	int** Content;
...
public:
	...
	/// \brief Диструктор, для удаления динамического двумерного массива.
	~Matrix();

	/// \brief Функция, которая создает матрицу (динамический двумерный массив).
	void DynamicArray();
...
/*!
	\brief Класс для выбора действия над матрицей.
	\authors Miroshnichenko Kostya
	\version 1.0
	\date 9/16/2022
*/ 
...
{
private:
	/// \brief Переменна принимающая номер операции над матрицей.
	int way;
