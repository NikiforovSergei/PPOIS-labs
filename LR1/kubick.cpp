...
/*****************************************************************//**
 * \file   kubick.cpp
 * \brief  Содержит в себе реализацию класса kubick.
 *********************************************************************/
...
{
    string commands;
    cout << "Введите грани кубика, которые хотите повернуть, через запятую (F,R,L,U,D,B,F',R',L',U',D',B'): ";
    cin >> commands;
    commands += ' ';
...
void RubiksCube::PositiveFront() //Поворот фронтальной части по часовой
{
    //Поворачиаем только лицевую часть
    ...
    facets[2] = front;
    //Поворачиваем соседние квадраты
