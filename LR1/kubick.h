 ...
 * @file
 * @brief Class kubick
 * Данный класс описывает кубик-рубика.
...
public:
     ...
     * В функции создается кубик-рубика с файла main.txt. Данный файл содержит собранный кубик-рубика для дальнейшего создания кубика-рубика с случайным расположением цветов.
     */
    void Initializate();
    /**
